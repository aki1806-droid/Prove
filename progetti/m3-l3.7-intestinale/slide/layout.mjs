...
import { CSS_GRAFICA, CORPI_GRAFICA, collega, FREGI, collegaIllustrazioni } from './grafica.mjs';
...
import { registra, illustrazione } from './figure.mjs';
collegaIllustrazioni(illustrazione);
