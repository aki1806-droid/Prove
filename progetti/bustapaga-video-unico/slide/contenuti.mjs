...
{id:"s002", tipo:"cedolino", tema:"chiaro", sopratitolo:"Ogni mese arriva",
  enunciato:"La apri, guardi l'**ultima riga**, e la chiudi.",
  evidenzia:{zona:"piede"}, etichetta:"l'unica riga che quasi tutti guardano"},
...
{id:"s005", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"Non serve essere esperti di contabilità",
...
{id:"s017", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"Sede di lavoro e modalità di pagamento",
...
{id:"s023", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"Chi lavora in più sedi",
...
{id:"s027", tipo:"cedolino", tema:"chiaro", sopratitolo:"Il corpo del cedolino",
  enunciato:"È una **tabella**: ogni riga è una voce, ogni colonna dice qualcosa di quella somma.",
  evidenzia:{zona:"corpo"}, etichetta:"capite le colonne, ogni riga diventa leggibile"},
...
{id:"s029", tipo:"prodotto", tema:"chiaro", sopratitolo:"La prova del nove",
  enunciato:"**Quantità × unitario** deve dare l'**importo**.",
  quantita:{cap:"Quantità", v:"19", d:"giorni di turno"},
  unitario:{cap:"Unitario", v:"2,07 €", d:"per giorno"},
  importo: {cap:"Importo",  v:"39,33 €", d:"quello che trovi in riga"},
  nota:"Se il conto non torna, c'è qualcosa da chiarire."},
...
{id:"s032", tipo:"cedolino", tema:"chiaro", sopratitolo:"Ultima colonna: scadenza o riferimento",
  enunciato:"Se il riferimento è **diverso dal mese di liquidazione**, riguarda un periodo passato.",
  evidenzia:{colonna:4}, etichetta:"indennità arretrate, conguagli — o la scadenza di un prestito"},
{id:"s033", tipo:"citazione", tema:"profondo", sfondo:true,
  testo:"Ho fatto le notti ad agosto: perché non le trovo nella busta di agosto?",
  fonte:"Il dubbio più frequente allo sportello"},
{id:"s034", tipo:"sfasamento", tema:"chiaro", sopratitolo:"Nella busta di ottobre",
  enunciato:"Turno, notte e festivo hanno riferimento **agosto**.",
  lavorato:"Agosto · i turni che hai fatto",
  pagato:"Ottobre · la busta che hai in mano",
  giorni:[1,2,4,5,7,8,10,11,13,15,16,18,19,21,22,24,26,28,30],
  freccia:"pagati due mesi dopo",
  nota:"Confronta la busta con il foglio presenze del mese indicato nel riferimento, non con quello corrente."},
...
{id:"s036", tipo:"titolo", tema:"profondo", sfondo:true,
...
{id:"s037", tipo:"prodotto", tema:"chiaro", sopratitolo:"Una prova del nove più difficile",
  enunciato:"Le ore, non i giorni: il servizio notturno si paga **a ora**.",
  quantita:{cap:"Quantità", v:"24", d:"ore notturne"},
  unitario:{cap:"Unitario", v:"2,74 €", d:"per ora"},
  importo: {cap:"Importo",  v:"65,76 €"},
  nota:"E i pasti in mensa: 6 × 1,03 € = 6,20 €. Se ti trovi a fare questi conti, sei già a metà del lavoro di controllo."},
...
{id:"s041", tipo:"cedolino", tema:"chiaro", sopratitolo:"E i valori negativi tra gli asterischi?",
  enunciato:"Un imponibile col **segno meno** vuol dire che sei **sotto la soglia**.",
  evidenzia:{righe:[5,6]}, etichetta:"niente soldi che escono: un numero che dice come stanno i conti"},
...
{id:"s045", tipo:"cedolino", tema:"chiaro", sopratitolo:"Le voci fisse",
  enunciato:"Arrivano ogni mese **uguali**, finché non cambia l'inquadramento o il contratto.",
  evidenzia:{righe:[0,2]}, etichetta:"se una voce fissa è sbagliata, l'errore si ripete ogni mese"},
...
{id:"s053", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"E se hai un incarico",
...
{id:"s059", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"Ma gli aumenti sono lordi",
...
{id:"s064", tipo:"cedolino", tema:"chiaro", sopratitolo:"La parte viva della busta",
  enunciato:"Racconta **come hai lavorato**: turni, notti, festivi, reperibilità, ore in più.",
  evidenzia:{righe:[3,5]}, etichetta:"sono anche le voci che si sbagliano più spesso"},
...
{id:"s071", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"La produttività",
...
{id:"s074", tipo:"soglia", tema:"chiaro", sopratitolo:"C'è un limite contrattuale ai turni di reperibilità",
  enunciato:"Più reperibilità del previsto non è una questione di soldi: è **organizzazione del lavoro**.",
  frazione:0.62, soglia:"il limite del contratto",
  sinistra:"entro il limite", destra:"oltre: si tratta al tavolo",
  nota:"Passa dal tavolo con l'Azienda. Segnalacelo."},
...
{id:"s085", tipo:"soglia", tema:"chiaro", sopratitolo:"Il contributo aggiuntivo dell'1%",
  enunciato:"Si applica **solo** sulla parte che supera una **soglia annua** fissata dalla legge.",
  frazione:0.72, soglia:"soglia annua di legge",
  sinistra:"nessun contributo aggiuntivo", destra:"solo qui l'1%",
  nota:"A volte è trattenuto in un mese ricco e poi restituito, se a fine anno la soglia non è stata superata."},
...
{id:"s090", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"Per i neoassunti c'è il silenzio assenso",
...
{id:"s106", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"L'IRPEF netta che trovi in busta",
...
{id:"s108", tipo:"frazione", tema:"chiaro", sopratitolo:"Dal 2026",
  enunciato:"Il salario accessorio è tassato al **15%**, non con la tua aliquota.",
  parti:100, piene:15, quota:"15%",
  testo:"su 100 euro di accessorio, 15 vanno in tasse",
  nota:"Fino a 800 € l'anno, per i pubblici non dirigenti con reddito fino a 50.000 €. In automatico, salvo rinuncia scritta."},
...
{id:"s118", tipo:"cedolino", tema:"chiaro", sopratitolo:"Le trattenute varie",
  enunciato:"Non dipendono dalla legge in generale, ma **da te**: dalle tue scelte o dalla tua situazione.",
  evidenzia:{righe:[4,6]}, etichetta:"e poi il piede, dove tutti i numeri si incontrano"},
...
{id:"s122", tipo:"sottrazione", tema:"chiaro", sopratitolo:"Il piede si verifica con una sottrazione",
  enunciato:"Quattro righe, e il conto deve tornare da solo.",
  righe:[{t:"Competenze lorde", v:"2.570,96 €", q:2570.96},
         {t:"Contributi e tasse", v:"554,87 €", q:-554.87},
         {t:"Trattenute varie", v:"25,62 €", q:-25.62},
         {t:"Netto", v:"1.990,47 €", tot:true}],
  nota:"Sono i numeri del fac-simile di Giulia. Fai la stessa colonna con i tuoi."},
...
{id:"s129", tipo:"frazione", tema:"chiaro", sopratitolo:"Il pignoramento presso terzi",
  enunciato:"Funziona come la cessione: **un quinto** — e per gli alimenti può essere di più.",
  parti:5, piene:1, quota:"1/5",
  testo:"la quota massima trattenibile sullo stipendio netto",
  nota:"Compare con una voce dedicata e il riferimento all'atto. Chiedi il conteggio, e verifica che alla fine del debito la trattenuta cessi."},
{id:"s130", tipo:"elenco", tema:"chiaro", sopratitolo:"Le assenze non retribuite — la colonna quantità dice quanti giorni sono stati decurtati", voci:[
  ...
  {t:"Lo **sciopero**"}]},
{id:"s131", tipo:"sottrazione", tema:"chiaro", sopratitolo:"Un mese con un recupero di 300 €",
  enunciato:"Le competenze lorde non cambiano: sale una riga sola, e il netto scende.",
  righe:[{t:"Competenze lorde", v:"2.570,96 €", q:2570.96},
         {t:"Contributi e tasse", v:"554,87 €", q:-554.87},
         {t:"Trattenute varie", v:"25,62 €", q:-25.62},
         {t:"Recupero", v:"300,00 €", q:-300, key:true},
         {t:"Netto", v:"1.690,47 €", tot:true}],
  nota:"Se non sai perché, la cifra sembra un errore. Se sai leggere il piede, vedi subito dove è finita."},
{id:"s132", tipo:"sottrazione", tema:"tenue", sopratitolo:"Un errore da non fare",
  enunciato:"Confondere il **netto** con il **netto a pagare**.",
  righe:[{t:"Netto", v:"1.990,47 €", q:1990.47},
         {t:"Arrotondamento", v:"0,47 €", q:-0.47},
         {t:"Netto a pagare", v:"1.990,00 €", tot:true, key:true}],
  nota:"Il netto è il risultato della sottrazione; il netto a pagare è quello arrotondato. Con l'accredito in banca confronta il secondo."},
...
{id:"s139", tipo:"cedolino", tema:"chiaro", sopratitolo:"Gli arretrati contrattuali",
  enunciato:"Li riconosci dalla colonna **riferimento**, che indica mesi e anni passati.",
  evidenzia:{colonna:4}, etichetta:"e dall'indennità di vacanza contrattuale, che viene riassorbita"},
...
{id:"s142", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"Anche la produttività arriva a saldo",
...
{id:"s164", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"La verifica mensile è un'abitudine",
...
{id:"s170", tipo:"barre", tema:"chiaro", sopratitolo:"Il comporto: fino a 18 mesi nei tre anni precedenti",
  ...
  {et:"Poi", v:90},
  {et:"Infine", v:50}]},
{id:"s171", tipo:"frazione", tema:"chiaro", sopratitolo:"La legge 104",
  enunciato:"I tre giorni al mese sono **retribuiti** e utili a tutti gli effetti, tredicesima compresa.",
  parti:21, piene:3, quota:"3 su 21",
  testo:"giorni di permesso su un mese di lavoro, pagati come lavorati",
  nota:"Non devi vedere trattenute. Se il sistema li registra come permesso non retribuito il netto scende: fallo correggere subito."},
...
{id:"s173", tipo:"frase", tema:"profondo", sfondo:true, sopratitolo:"Durante maternità e congedi",
...
{id:"s176", tipo:"soglia", tema:"chiaro", sopratitolo:"Il buono pasto",
  enunciato:"Il diritto nei turni di **almeno sei ore** è riconosciuto da molte sentenze, e oggi dal contratto.",
  frazione:0.50, soglia:"sei ore di turno",
  sinistra:"turno più corto", destra:"sei ore o più: ti spetta",
  nota:"Non è in busta come voce di paga, ma può esserci come trattenuta di quota parte. Se nel tuo reparto viene negato, la CISL FP assiste i ricorsi."},
...
{id:"s181", tipo:"cedolino", tema:"chiaro", sopratitolo:"Adesso mettiamo insieme tutto",
  enunciato:"Il cedolino di ottobre di **Giulia**, infermiera — letto come faresti tu a casa.",
  etichetta:"con il prospetto turni di agosto accanto, zona per zona"},
...
{id:"s183", tipo:"cedolino", tema:"chiaro", sopratitolo:"2 · Voci fisse",
  enunciato:"Le stesse del mese prima, **stessi importi**.",
  evidenzia:{righe:[0,2]}, etichetta:"tabellare, vacanza contrattuale, differenziale, indennità professionali"},
...
{id:"s186", tipo:"tabella", tema:"chiaro", sopratitolo:"5 · Tasse",
  ...
  chiave:[1]},
{id:"s187", tipo:"cedolino", tema:"chiaro", sopratitolo:"6 · Trattenute varie",
  enunciato:"Contributo sindacale e **sei pasti** in mensa. Niente prestiti, niente recuperi.",
  evidenzia:{zona:"piede"}, etichetta:"e in fondo le righe con l'asterisco: imponibili e detrazioni"},
...
{id:"s206", tipo:"domanda", tema:"chiaro", sopratitolo:"Le domande dello sportello",
  domanda:"Posso avere la busta paga in formato cartaceo?", esito:"si",
  risposta:"Ma oggi quasi tutte le Aziende la mettono nel **portale del dipendente**.",
  nota:"Scaricala e archiviala ogni mese: il portale può non conservarla per sempre, e tra qualche anno potresti averne bisogno."},
{id:"s207", tipo:"citazione", tema:"profondo", sfondo:true,
...
{id:"s208", tipo:"domanda", tema:"chiaro", sopratitolo:"Le domande dello sportello",
  domanda:"Mi hanno tolto dei soldi con la voce recupero: possono farlo?", esito:"si",
  risposta:"Se la somma non era dovuta **e lo dimostrano**.",
  nota:"Ma devono darti il conteggio, e non possono trattenere tutto in una volta se l'importo è alto. Chiedi la rateizzazione — e se è vecchio di anni, fatti aiutare a verificare la prescrizione."},
...
{id:"s210", tipo:"domanda", tema:"chiaro", sopratitolo:"Le domande dello sportello",
  domanda:"La tredicesima è più bassa dello stipendio: è normale?", esito:"si",
  risposta:"Si calcola **solo sulle voci fisse**, ed è tassata senza detrazioni.",
  nota:"Per questo il netto di dicembre non è il doppio di un mese normale."},
...
{id:"s213", tipo:"domanda", tema:"chiaro", sopratitolo:"Le domande dello sportello",
  domanda:"Posso far controllare la busta paga anche se non sono iscritta?", esito:"dipende",
  risposta:"Puoi venire in sede e **parlare con noi**.",
  nota:"Le verifiche complete, l'assistenza legale e il 730 con il CAF sono servizi per gli iscritti: il contributo sindacale che hai visto in busta serve anche a questo."},
{id:"s214", tipo:"domanda", tema:"chiaro", sopratitolo:"Le domande dello sportello",
  domanda:"Ho un part time e faccio anche le notti: le indennità sono ridotte?", esito:"no",
  risposta:"La notte che fai è pagata come quella di un collega a tempo pieno.",
  nota:"Il fisso è riproporzionato, le voci accessorie no. Se vedi un'indennità notturna ridotta in proporzione al part time, è un errore."},
