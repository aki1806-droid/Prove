# REGISTRO — Lezione 5.3 · Il responsabile del procedimento
...
**Fonti**: L. 241/1990 artt. 4, 5, 6, 6-bis (unità organizzativa, assegnazione, funzionario preposto all'unità come responsabile in mancanza di assegnazione, compiti istruttori, conflitto di interessi); dispensa CISL FP (con la correzione: non «RUP»).
...
| stacco | dopo **s26** |
| grezzo | A 290,88 s · B 259,20 s = 550,1 s |
| parlato lavorato | **411,9 s** (10 pose) |
| CPS misurato | 17,8 car/s sul lavorato |
| montato locale | **7:05,32** |
| montato HeyGen | **{HG}** |

## Verifiche

- **Trascrizione delle tracce intere** (da asset audio, `eleven_scribe_v1`):
  A: 605/605 parole, 0 buchi
  B: 538/538 parole, 0 buchi
- **Confini**: Nessuna coppia di segno opposto. Durata a 7:01,9: aggiunte pose di 0,6 s ai blocchi delle trappole, 7:04,9.
  `audio/correzioni.json` = nessuna.
- **Temi cambiati rispetto al copione**: nessuno.
- **Slide**: PNG guardati in provini da nove, traboccamento verificato con i caratteri veri.
  - **s12**: sigla accorciata a «Il preposto» (finiva sotto il sigillo).
  - **s29**: illustrazione `bivio` (Istruttoria / Decisione motivata).
- `controlli.py`: 8/8.
...
```
voce, due tracce, 7.330 caratteri, eleven_v3        ≈ $1,21  (stimato sui caratteri)
trascrizione delle due tracce intere               ≈ $0,50  (stimato sui secondi)
                                                    -------
                                                    ≈ $1,70
```
...
- Da confrontare con le fonti, in particolare:
  - Tolta prima della voce la frase «il responsabile resta lo stesso», senza fonte.
  - Il rapporto fra **6-bis** e codice di comportamento (D.P.R. 62/2013) è riassunto, non citato.
