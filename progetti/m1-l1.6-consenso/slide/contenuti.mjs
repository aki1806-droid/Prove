...
const ARTICOLIG = [
 {n:"1", t:"**Consenso informato**"},
 {n:"2", t:"**Terapia del dolore**", d:"divieto di ostinazione irragionevole"},
 {n:"3", t:"**Minori e incapaci**"},
 {n:"4", t:"**DAT** e fiduciario"},
 {n:"5", t:"**Pianificazione condivisa** delle cure"},
 {n:"6", t:"Norma **transitoria**"},
 {n:"7", t:"**Formazione** degli operatori"},
 {n:"8", t:"**Relazione** alle Camere"},
];
const INFORMA = [
 {t:"**Condizioni di salute**"},
 {t:"**Diagnosi** e **prognosi**"},
 {t:"**Benefici e rischi** degli accertamenti e trattamenti"},
 {t:"Possibili **alternative**"},
 {t:"Conseguenze del **rifiuto** o della rinuncia", key:true},
];
const DISATTENDERE = [
 {icona:"avviso",   t:"Palesemente incongrue"},
 {icona:"orologio", t:"Non corrispondono alla condizione clinica attuale"},
 {icona:"ingranaggio", t:"Esistono terapie non prevedibili alla sottoscrizione"},
];
...
{id:"s04", tipo:"icone", tema:"chiaro", sopratitolo:"Quattro tappe", voci:[
  ...
  {icona:"libro",    t:"La legge 219/2017", d:"articolo per articolo"},
...
{id:"s06", tipo:"icone", tema:"chiaro", sopratitolo:"Il fondamento costituzionale", voci:[
  ...
  {icona:"lucchetto", t:"Art. 13", d:"la **libertà personale** è inviolabile"},
  {icona:"cuoremano", t:"Art. 32", d:"la **norma chiave** del consenso", key:true}]},
...
{id:"s09", tipo:"tabella", tema:"chiaro", sopratitolo:"Due conseguenze pratiche dell'art. 32",
  ...
  righe:[
   ["Il trattamento","si:il **consenso** della persona","no:l'**obbligo**, solo per legge"],
   ["Il limite invalicabile","—","il **rispetto della persona umana**"]]},
...
{id:"s11", tipo:"griglia", tema:"chiaro", colonne:2, attive:[0,1,2],
  sopratitolo:"Gli otto articoli della legge 219", celle:ARTICOLIG},

{id:"s12", tipo:"griglia", tema:"chiaro", colonne:2, attive:[0,1,2,3,4,5,6,7],
  sopratitolo:"Gli otto articoli della legge 219", celle:ARTICOLIG},
...
{id:"s18", tipo:"griglia", tema:"chiaro", colonne:1, attive:[0,1,2,3],
  sopratitolo:"Su che cosa deve vertere l'informazione", celle:INFORMA},
...
{id:"s22", tipo:"tabella", tema:"chiaro", sopratitolo:"La forma del consenso",
  ...
  righe:[
   ["si:Forma **scritta**","in cartella clinica"],
   ["si:**Videoregistrazione**","per chi non può scrivere"],
   ["si:**Dispositivi** che consentano di comunicare","per chi ha disabilità"],
   ["no:«solo se firmato su modulo cartaceo»","è il distrattore: la legge dice il contrario"]]},
...
{id:"s27", tipo:"tabella", tema:"chiaro", sopratitolo:"L'autodeterminazione è asimmetrica",
  intestazioni:["","Rifiutare","Pretendere"], colonne:["24%","38%","38%"],
  chiave:[0],
  righe:[
   ["Si può?","si:**sì**, qualsiasi trattamento","no:**no**"],
...
{id:"s30", tipo:"albero", tema:"chiaro", sopratitolo:"Chi esprime il consenso — art. 3",
  radice:"La persona non può decidere da sola", rami:[
   {cond:"minore", esito:"Esercenti la **responsabilità genitoriale** o tutore — la volontà del minore è **ascoltata e valorizzata**"},
   {cond:"interdetto", esito:"Il **tutore**, sentito l'interdetto ove possibile"},
   {cond:"inabilitato", esito:"**Presta personalmente** il consenso", key:true},
   {cond:"amministrazione di sostegno", esito:"**Dipende dal decreto di nomina**: va letto"}]},

{id:"s31", tipo:"albero", tema:"chiaro", sopratitolo:"Chi esprime il consenso — art. 3",
  radice:"La persona non può decidere da sola", rami:[
   {cond:"minore", esito:"Esercenti la **responsabilità genitoriale** o tutore — la volontà del minore è **ascoltata e valorizzata**"},
   {cond:"interdetto", esito:"Il **tutore**, sentito l'interdetto ove possibile"},
   {cond:"inabilitato", esito:"**Presta personalmente** il consenso", key:true},
...
{id:"s33", tipo:"catena", tema:"chiaro", sopratitolo:"Il rappresentante legale rifiuta cure necessarie",
  passi:[{t:"Non si esegue d'autorità"},
         {t:"Non si desiste"},
         {t:"Si ricorre al **giudice tutelare**", d:"salvo lo stato di necessità", key:true}]},
...
{id:"s37", tipo:"icone", tema:"chiaro", sopratitolo:"La forma delle DAT", voci:[
  ...
  {icona:"documento",   t:"Scrittura privata autenticata"},
...
{id:"s41", tipo:"tabella", tema:"chiaro", sopratitolo:"DAT o pianificazione condivisa",
  ...
  righe:[
   ...
   ["Chi le fa","la persona, **da sola**","la persona **con il medico** e l'équipe"],
...
{id:"s44", tipo:"tabella", tema:"chiaro", sopratitolo:"Sedazione palliativa o eutanasia: tre criteri",
  intestazioni:["Criterio","Sedazione palliativa profonda","Eutanasia"], colonne:["24%","38%","38%"],
  chiave:[0],
  righe:[
   ["**Obiettivo**","controllare un **sintomo refrattario**","la **morte**"],
...
{id:"s46", tipo:"griglia", tema:"chiaro", colonne:2, attive:[0,1,2],
  ...
  {t:"**Acquisisce il consenso** per gli atti di propria competenza"},
  {t:"**Contribuisce** alla relazione di cura"},
  {t:"**Verifica la comprensione**"},
  {t:"**Documenta** consenso, rifiuto e volontà di non essere informati"},
  {t:"**Tutela la volontà espressa**, anche quando non la condivide"},
  {t:"**Non sostituisce il medico** nella diagnosi, ma non elude"}]},

{id:"s47", tipo:"griglia", tema:"chiaro", colonne:2, attive:[0,1,2,3,4,5],
  sopratitolo:"Il ruolo dell'infermiere", celle:[
  {t:"**Acquisisce il consenso** per gli atti di propria competenza"},
  {t:"**Contribuisce** alla relazione di cura"},
  {t:"**Verifica la comprensione**"},
...
{id:"s49", tipo:"catena", tema:"chiaro", sopratitolo:"«Ho firmato senza capire»",
  passi:[{t:"Sospendere il percorso"},
         {t:"Informare il medico"},
         {t:"Documentare", d:"quel consenso non è informato, quindi non è valido", key:true}]},
