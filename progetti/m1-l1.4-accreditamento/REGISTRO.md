...
| montato HeyGen | **7:12,03 (432,03 s; 1,21 s meno del locale)** |
...
- Lotto HeyGen `b9a03913e8ef467b8520e67837011638`: 90 file accoppiati per posizione, 0 discordi sul `content-type`.
- **s45.mp3 è rimasto in `processing`** oltre sei minuti: ricaricato da solo nel lotto `c944aae715dd4714a3b585033a090bd1` (asset `0500abc0d7e041f6a509e879c584a3c1`).
- Payload: 46 scene; 44 scene video, tutte con `audio_asset_id` e `playback {freeze, mute}`.
- Video HeyGen: `7ddd178907ef9105cfce738d6fdec716` (https://app.heygen.com/videos/7ddd178907ef9105cfce738d6fdec716).
