...
import { CSS_ILL, CORPI_ILL, collegaIll } from './illustra.mjs';
...
.logo img{display:block;height:92px;width:auto}   /* il marchio CISL FP e' quasi quadrato: a 70px spariva */
...
${CSS_GRAFICA}
${CSS_ILL}
.corpo>.ills,.corpo>.flu,.corpo>.cic,.corpo>.ret,.corpo>.cont{animation:none}
...
const TUTTI = { ...CORPI, ...CORPI_GRAFICA, ...CORPI_ILL };
...
<body><div class="slide ${cover?'cover':''} ${t.scuro?'scuro':''}"
  ...
  <div class="logo"><img src="${MARCHIO}" alt="CISL FP"></div>
