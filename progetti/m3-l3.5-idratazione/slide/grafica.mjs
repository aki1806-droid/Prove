...
// Un nome che non e' fra le icone a 24 cade sulle illustrazioni a 240
// (figure.mjs e clinica.mjs), che layout.mjs collega qui all'avvio.
let ripiego = null;
export const collegaIllustrazioni = fn => { ripiego = fn; };
export const icona = (n, cls='') =>
  I[n] || !ripiego ? `<svg class="ico ${cls}" viewBox="0 0 24 24" fill="none" stroke="currentColor"
...
.griglia .c{min-width:0;border:3px solid var(--linea);border-radius:18px;padding:30px 28px;
...
.griglia .c .t{font-size:31px;line-height:1.3;color:var(--fg);overflow-wrap:anywhere}
...
.icone .v .illu{width:150px;height:150px;flex:0 0 auto;color:var(--acc)}
.icone.fitte .v .illu{width:110px;height:110px}
