...
BLOCCHI = [
 ...
 (4,"tenue",0,"2000: la legge 251, autonomia professionale e dirigenza. Sono i sei passaggi con cui si racconta il primo quarto di secolo della professione."),
 ...
 (5,"chiaro",0,"2017: due leggi, e le vediamo fra un attimo. 2018: la legge 3, e nascono gli Ordini. 2019: il Codice deontologico delle Professioni Infermieristiche."),
 ...
 (8,"profondo",0,"E' la distinzione del DM 739 e vale una domanda in ogni prova. Il verbo cambia con il tipo di bisogno, non con il tipo di paziente."),
 ...
 (9,"tenue",0,"Il modo per non sbagliarle sotto esame e' legarle al motivo: esonero quando studi, esenzione quando sei assente."),
 (9,"chiaro",0,"Quarta: livello o incarico? Il titolo abilita, l'azienda attribuisce. Si puo' avere il master di coordinamento senza avere l'incarico di coordinatore."),
 ...
 (11,"tenue",0,"Non ti nascondi dietro la prescrizione quando l'errore e' riconoscibile: il principio di affidamento cade davanti all'errore palese."),
 ...
 (13,"profondo",1.2,"L'assistenza infermieristica e' di natura tecnica, relazionale ed educativa. La sicurezza delle cure e' parte costitutiva del diritto alla salute."),
 ...
 (15,"tenue",0,"Rivedi le lezioni segnalate. Non e' pignoleria: il modulo 1 e' la grammatica di tutto il resto del corso, e i moduli successivi lo danno per acquisito."),
 ...
 (17,"profondo",0,"E infine la frase che tiene insieme tutto il modulo: cio' che non e' documentato si presume non fatto. Ci vediamo nel modulo 2."),
]
