...
`slide/figure.mjs`), usato sia per i PNG fermi sia per i fotogrammi delle clip. Le due cose **devono** uscire
...
**vocabolario chiuso** — diciannove tipi, le icone e ventiquattro illustrazioni
...
| `slide/figure.mjs` | 436 | 24 illustrazioni che si disegnano, i 6 tipi della seconda generazione |
...
corpi di testo. Importa le due librerie grafiche e rifiuta i tipi con dati sul
